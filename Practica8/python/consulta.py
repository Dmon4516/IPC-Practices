...
class VentanaConsulta ( wx.Frame ):
    ...
    def __init__( self, parent ):
        ...
        self.toolImprimir = self.toolBar.AddTool( 1, _(u"Imprimir"), wx.Bitmap( u"./imagenes/imprimir.png", wx.BITMAP_TYPE_ANY ), wx.NullBitmap, wx.ITEM_NORMAL, wx.EmptyString, "Imprime en papel la lista completa de vehículos en el taller.", None )
        self.Bind(wx.EVT_TOOL, self.toolImprimirClicked, id = 1)

        self.toolActualizar = self.toolBar.AddTool( 2, _(u"Actualizar"), wx.Bitmap( u"./imagenes/actualizar.png", wx.BITMAP_TYPE_ANY ), wx.NullBitmap, wx.ITEM_NORMAL, wx.EmptyString, "Actualiza los datos de todos los vehículos a su última revisión.", None )
        self.Bind(wx.EVT_TOOL, self.toolActualizarClicked, id = 2)
        self.toolBar.AddSeparator()

        self.toolSalir = self.toolBar.AddTool( 3, _(u"Salir"), wx.Bitmap( u"./imagenes/salir.png", wx.BITMAP_TYPE_ANY ), wx.NullBitmap, wx.ITEM_NORMAL, wx.EmptyString, "Salir de esta ventana.", None )
