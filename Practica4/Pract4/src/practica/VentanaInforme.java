...
public class VentanaInforme {
	...
	private void initialize() {
		...
		frmInforme.setIconImage(Toolkit.getDefaultToolkit().getImage(VentanaPrincipal.class.getResource("/imagenes/icono.png")));
		...
		cbFuente.setModel(new DefaultComboBoxModel(new String[] {"Arial", "Calibri", "Courier New", "Helvetica", "Tahoma", "Times New Roman"}));
		...
		JScrollPane scrollPane = new JScrollPane(tpEditor,
